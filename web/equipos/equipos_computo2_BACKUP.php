                    ...
                    <div ng-controller="forms3Controller as Ctrl" class="col-lg-12">
                        <form role="form" class="form" id="datosFormAutocomplete">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="serie" ng-model="form.SSN" ng-class="{'floating-label': !equipos.equipo.data.ASSETTAG}" class="form-control  Sip ng-dirty ng-invalid ng-valid" required/>
