(function() {
    ...
    app.controller("equipoController", function($compile, $scope, $http, DTOptionsBuilder, DTColumnBuilder, EquipService){

        $scope.submit=undefined;
        var vm = this;
        vm.equipos= {data:undefined};
        vm.equipo_table= {data:undefined};
        ...
        function getEquipos () {
            ...
            $promese = $http.get("equipoController?get_equipos=1");
            $promese.then(function(data) {
                vm.equipo_table.data = data.data;                 
            });
            return $promese;
        };
